...
public class MemberController {
	...
	public String delete(int num) {
		System.out.println(num+"번째 회원 삭제 합니다");
		/*
		 * 리다일렉트 응답 할때는 "redirect: 새로 요청할 경로" 형식으로 view page 정보를 작성하면 된다.
		 */
		return "redirect:/"; //index page 가 나온다.
    ...
    *     private String addr; => <input name="addr">  파라미터 명과 일치 하면 따로 넣을 필요 x
    *  }
    *  
    */
